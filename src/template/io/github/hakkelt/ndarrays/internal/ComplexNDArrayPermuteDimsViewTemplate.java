 ...
 */
@ClassTemplate(outputDirectory = "main/java/io/github/hakkelt/ndarrays/internal", newName = "ComplexNDArrayPermuteDimsView")
public class ComplexNDArrayPermuteDimsViewTemplate<T extends Number> extends AbstractNDArrayPermuteDimsView<Complex,T> implements ComplexNDArray<T> {

    public ComplexNDArrayPermuteDimsViewTemplate(NDArray<Complex> parent, int ...dimsOrder) {
    ...
    @Replacements({"setReal", "int... indices", "indices"})
    @Replacements({"setImag", "int linearIndex", "linearIndex"})
    @Replacements({"setImag", "int... indices", "indices"})
