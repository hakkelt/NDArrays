 ...
 */
@ClassTemplate(outputDirectory = "main/java/io/github/hakkelt/ndarrays/internal", newName = "RealNDArrayReshapeView")
public class RealNDArrayReshapeViewTemplate<T extends Number> extends AbstractNDArrayReshapeView<T,T> implements RealNDArray<T> {

    public RealNDArrayReshapeViewTemplate(NDArray<T> parent, int ...newShape) {
