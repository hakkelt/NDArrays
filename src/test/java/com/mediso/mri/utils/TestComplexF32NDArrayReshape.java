...
public class TestComplexF32NDArrayReshape {
    ...
    public void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("NDArray<ComplexF32>(20 × 3)\n")
    ...
    public void testToRS2DDataSetTooManyDimensions() {
        NDArray<Complex> array2 = new ComplexF32NDArray(new int[]{2,2,2,2,2,2}).reshape(8,8,1,1,1,1);
