...
class TestRealF64NDArrayMask {
    ...
    void setup() {
        ...
        mask = new RealInt8NDArray(array.mapWithLinearIndices((value, index) -> (double)index % 2));
    ...
    @Test
    void testMaskMask() {
        NDArray<Byte> mask2 = new RealInt8NDArray(masked.map(value -> value > 20 ? 1. : 0.));
    ...
    void testMaskInverseMask() {
        NDArray<Byte> mask2 = new RealInt8NDArray(masked.map(value -> value > 20 ? (double)1 : (double)0));
    ...
    @Test
    void testEqual() {
        NDArray<Double> array2 = new RealF64NDArray(masked);
    ...
    void testCollector() {
        NDArray<Double> increased = masked.stream()
            .map((value) -> value + 1)
            .collect(RealF64NDArray.getCollector(masked.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Double>(30)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Double>(30)")
    ...
    void testConcatenate() {
        NDArray<Double> array2 = new RealF64NDArray(5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Double> array3 = new RealF64NDArray(5).permuteDims(0);
        NDArray<Double> array4 = new RealF64NDArray(3, 3).fill(2).reshape(9);
