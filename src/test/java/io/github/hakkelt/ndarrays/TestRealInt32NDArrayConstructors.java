...
class TestRealInt32NDArrayConstructors {

    @Test
    void testDimsConstructor() {
        int[] dims = { 2, 4 };
        NDArray<Integer> array = new RealInt32NDArray(dims);
    ...
    void testDimsAnd1DIntegerArrayConstructor() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = i;
        NDArray<Integer> array = new RealInt32NDArray(dims).copyFrom(real);
        short idx = 0;
    ...
    void test1DIntegerArrayConstructors() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = i;
        NDArray<Integer> array = RealInt32NDArray.of(real);
    ...
    void testCopyConstructor() {
        ...
        NDArray<Integer> array1 = new RealInt32NDArray(dims).copyFrom(real);
        NDArray<Integer> array2 = new RealInt32NDArray(array1);
        array1.set(0, 2,2,2);
        for (int k = 0; k < dims[2]; k++)
            for (int j = 0; j < dims[1]; j++)
                for (int i = 0; i < dims[0]; i++) {
