...
class TestRealInt16NDArrayMask {
    ...
    void setup() {
        ...
        mask = new RealInt8NDArray(array.mapWithLinearIndices((value, index) -> (short)(index.intValue() % 2)));
    ...
    @Test
    void testMaskMask() {
        NDArray<Byte> mask2 = new RealInt8NDArray(masked.map(value -> value > 20 ? (short)1 : (short)0));
    ...
    @Test
    void testEqual() {
        NDArray<Short> array2 = new RealInt16NDArray(masked);
    ...
    void testCollector() {
        NDArray<Short> increased = masked.stream()
            .map((value) -> value + 1)
            .collect(RealInt16NDArray.getCollector(masked.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Short>(30)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Short>(30)")
    ...
    void testConcatenate() {
        NDArray<Short> array2 = new RealInt16NDArray(5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Short> array3 = new RealInt16NDArray(5).permuteDims(0);
        NDArray<Short> array4 = new RealInt16NDArray(3, 3).fill(2).reshape(9);
