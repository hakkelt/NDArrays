...
class TestRealInt64NDArrayReshape {
    ...
    @Test
    void testEqual() {
        NDArray<Long> array2 = new RealInt64NDArray(reshaped);
    ...
    void testCollector() {
        NDArray<?> increased = reshaped.stream()
            .map((value) -> value + 1)
            .collect(RealInt64NDArray.getCollector(reshaped.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Long>(20 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Long>(20 × 3)" + System.lineSeparator())
    ...
    @Test
    void testApply() {
        NDArray<Long> reshaped2 = new RealInt64NDArray(array).reshape(20, 3);
    ...
    void testMaskReshaped() {
        NDArray<Byte> mask = new RealInt8NDArray(reshaped.map(value -> value > 20 ? (long)1 : (long)0));
    ...
    void testConcatenate() {
        NDArray<Long> array2 = new RealInt64NDArray(new int[]{5, 3}).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Long> array3 = new RealInt64NDArray(new int[]{3, 2}).permuteDims(1, 0);
        NDArray<Long> array4 = new RealInt64NDArray(new int[]{9}).fill(2).reshape(3, 3);
