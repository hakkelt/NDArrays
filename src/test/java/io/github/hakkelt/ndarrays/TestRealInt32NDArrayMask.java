...
class TestRealInt32NDArrayMask {
    ...
    void setup() {
        ...
        mask = new RealInt8NDArray(array.mapWithLinearIndices((value, index) -> index.intValue() % 2));
    ...
    @Test
    void testEqual() {
        NDArray<Integer> array2 = new RealInt32NDArray(masked);
    ...
    void testCollector() {
        NDArray<Integer> increased = masked.stream()
            .map((value) -> value + 1)
            .collect(RealInt32NDArray.getCollector(masked.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Integer>(30)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Integer>(30)")
    ...
    void testConcatenate() {
        NDArray<Integer> array2 = new RealInt32NDArray(5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Integer> array3 = new RealInt32NDArray(5).permuteDims(0);
        NDArray<Integer> array4 = new RealInt32NDArray(3, 3).fill(2).reshape(9);
