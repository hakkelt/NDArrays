...
class TestRealInt32NDArrayFunctions {
    RealInt32NDArray array;
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Integer>(4 × 5 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Integer>(4 × 5 × 3)" + System.lineSeparator())
    ...
    @Test
    void testDivide() {
        NDArray<Integer> array2 = new RealInt32NDArray(array.addInplace(1));
    ...
    void test1Norm() {
        ...
        assertTrue(Math.abs((int)norm - array.norm(1)) / (int)norm < 1e-6);
    }
    ...
    void testConcatenate() {
        NDArray<Integer> array2 = new RealInt32NDArray(new int[]{4, 2, 3}).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Integer> array3 = new RealInt32NDArray(new int[]{3, 4, 4}).permuteDims(2, 1, 0);
        NDArray<Integer> array4 = new RealInt32NDArray(new int[]{12}).fill(2).reshape(4, 1, 3);
