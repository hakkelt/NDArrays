...
class TestRealF32NDArrayMask {
    ...
    void setup() {
        ...
        mask = new RealInt8NDArray(array.mapWithLinearIndices((value, index) -> (float)index % 2));
    ...
    @Test
    void testMaskMask() {
        NDArray<Byte> mask2 = new RealInt8NDArray(masked.map(value -> value > 20 ? (float)1 : (float)0));
    ...
    @Test
    void testEqual() {
        NDArray<Float> array2 = new RealF32NDArray(masked);
    ...
    void testCollector() {
        NDArray<Float> increased = masked.stream()
            .map((value) -> value + 1)
            .collect(RealF32NDArray.getCollector(masked.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Float>(30)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Float>(30)")
    ...
    void testConcatenate() {
        NDArray<Float> array2 = new RealF32NDArray(5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Float> array3 = new RealF32NDArray(5).permuteDims(0);
        NDArray<Float> array4 = new RealF32NDArray(3, 3).fill(2).reshape(9);
