...
class TestRealInt64NDArraySlice {
    ...
    @Test
    void testEqual() {
        NDArray<Long> array2 = new RealInt64NDArray(slice);
    ...
    void testCollector() {
        NDArray<Long> increased = slice.stream()
            .map((value) -> value + 1)
            .collect(RealInt64NDArray.getCollector(slice.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Long>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Long>(3 × 3)" + System.lineSeparator())
    ...
    @Test
    void testApply() {
        NDArray<Long> slice2 = new RealInt64NDArray(array).slice(1, "1:4", ":");
