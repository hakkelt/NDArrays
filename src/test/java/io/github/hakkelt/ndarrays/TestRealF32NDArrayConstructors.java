...
class TestRealF32NDArrayConstructors {
    ...
    void testDimsAnd1DFloatArrayConstructor() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = i;
        NDArray<Float> array = new RealF32NDArray(dims).copyFrom(real);
        int idx = 0;
    ...
    void test1DFloatArrayConstructors() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = i;
        NDArray<Float> array = RealF32NDArray.of(real);
        for (int i = 0; i < real.length; i++)
    ...
    void testCopyConstructor() {
        ...
        NDArray<Float> array1 = new RealF32NDArray(dims).copyFrom(real);
