...
class TestBasicIntegerNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<Integer>(4 × 5 × 3)", str);
    }

    @Test
    void testcontentToString() {
        String str = array.contentToString();
        String firstLine = array.getNamePrefix() + " NDArray<Integer>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToInteger(index));
        NDArray<Integer> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToInteger(index));
        NDArray<Integer> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToInteger(index));
        NDArray<Integer> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<Integer> array2 = new BasicIntegerNDArray(4, 2, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Integer> array3 = new BasicIntegerNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<Integer> array4 = new BasicIntegerNDArray(12).fill(2).reshape(4, 1, 3);
