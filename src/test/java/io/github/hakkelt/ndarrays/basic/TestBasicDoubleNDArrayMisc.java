...
class TestBasicDoubleNDArrayMisc extends TestBase {
    ...
    void setup() {
        ...
        array.fillUsingLinearIndices(TestBase::wrapToDouble);
    ...
    void testDTypeWithArray() {
        assertEquals(Double.class, array.dtype());
    }

    @Test
    void testDTypeWithSlice() {
        assertEquals(Double.class, slice.dtype());
    }

    @Test
    void testDTypeWithReshaped() {
        assertEquals(Double.class, reshaped.dtype());
    }
    ...
    void testDTypeWithMasked() {
        assertEquals(Double.class, masked.dtype());
    }

    @Test
    void testWrongToArrayWithArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> array.toArray(new Double[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithSlice() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> slice.toArray(new Double[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithReshaped() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> reshaped.toArray(new Double[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithPArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> pArray.toArray(new Double[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithMasked() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> masked.toArray(new Double[0][][]));
    ...
    void testNotEqualsWithArray() {
        ...
        assertNotEquals(array, new BasicDoubleNDArray(IntStream.of(array.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(array, new BasicDoubleNDArray(array.shape()));
    }
    ...
    void testNotEqualsWithSlice() {
        ...
        assertNotEquals(slice, new BasicDoubleNDArray(IntStream.of(slice.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(slice, new BasicDoubleNDArray(slice.shape()));
    }
    ...
    void testNotEqualsWithReshaped() {
        ...
        assertNotEquals(reshaped, new BasicDoubleNDArray(IntStream.of(reshaped.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(reshaped, new BasicDoubleNDArray(reshaped.shape()));
    }
    ...
    void testNotEqualsWithPArray() {
        ...
        assertNotEquals(pArray, new BasicDoubleNDArray(IntStream.of(pArray.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(pArray, new BasicDoubleNDArray(pArray.shape()));
    }
    ...
    void testNotEqualsWithMasked() {
        ...
        assertNotEquals(masked, new BasicDoubleNDArray(IntStream.of(masked.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(masked, new BasicDoubleNDArray(masked.shape()));
    }
    ...
    void testSliceEqualsWithSameType() {
        NDArray<Double> slice2 = array.slice(1, "1:4", "0:");
        assertEquals(slice, slice2);
        NDArray<Double> slice3 = array.copy().slice(1, "1:4", "0:");
        assertEquals(slice, slice3);
    }

    @Test
    void testReshapedEqualsWithSameType() {
        NDArray<Double> reshaped2 = array.reshape(20, 3);
        assertEquals(reshaped, reshaped2);
        NDArray<Double> reshaped3 = array.copy().reshape(20, 3);
    ...
    void testPArrayEqualsWithSameType() {
        ...
        NDArray<Double> pArray3 = array.copy().permuteDims(0, 2, 1);
    ...
    void testMaskedEqualsWithSameType() {
        ...
        NDArray<Double> masked3 = array.copy().mask(mask);
        assertEquals(masked, masked3);
        NDArray<Double> masked4 = array.mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked4);
        NDArray<Double> masked5 = array.copy().mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked5);
        NDArray<Double> masked6 = array.maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked6);
        NDArray<Double> masked7 = array.copy().maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked7);
        NDArray<Double> masked8 = array.maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
        assertEquals(masked, masked8);
        NDArray<Double> masked9 = array.copy().maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
    ...
    void testFillDoubleWithArray() {
        ...
        for (Double elem : array)
            assertSpecializedEquals(wrapToDouble(3), elem);
    }
    ...
    void testContaintsWithArray() {
        assertTrue(array.contains(wrapToDouble(5)));
    }

    @Test
    void testContaintsWithSlice() {
        assertTrue(slice.contains(wrapToDouble(5)));
    }

    @Test
    void testContaintsWithReshaped() {
        assertTrue(reshaped.contains(wrapToDouble(5)));
    }

    @Test
    void testContaintsWithPArray() {
        assertTrue(pArray.contains(wrapToDouble(5)));
    }

    @Test
    void testContaintsWithMasked() {
        assertTrue(masked.contains(wrapToDouble(5)));
    }
