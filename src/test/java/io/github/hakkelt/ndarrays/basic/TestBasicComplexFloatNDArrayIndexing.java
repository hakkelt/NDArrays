...
class TestBasicComplexFloatNDArrayIndexing extends TestBase {
    ...
    void setup() {
        ...
        mask = new BasicComplexFloatNDArray(array.mapWithLinearIndices((value, index) -> wrapToComplex((double) (index % 2))));
