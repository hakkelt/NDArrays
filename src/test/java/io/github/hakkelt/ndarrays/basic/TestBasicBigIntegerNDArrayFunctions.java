...
class TestBasicBigIntegerNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<BigInteger>(4 × 5 × 3)", str);
    }
    ...
    @Test
    void testSelectDims() {
        array = new BasicBigIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigInteger(index));
        NDArray<BigInteger> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicBigIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigInteger(index));
        NDArray<BigInteger> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicBigIntegerNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigInteger(index));
        NDArray<BigInteger> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<BigInteger> array2 = new BasicBigIntegerNDArray(4, 2, 3).fill(1);
        NDArray<BigInteger> array3 = array.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<BigInteger> array2 = array.copy().fill(1).slice(":", "1:3", ":");
        NDArray<BigInteger> array3 = new BasicBigIntegerNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<BigInteger> array4 = new BasicBigIntegerNDArray(12).fill(2).reshape(4, 1, 3);
        NDArray<BigInteger> array5 = array.concatenate(1, array2, array3, array4);
        int start = 0;
