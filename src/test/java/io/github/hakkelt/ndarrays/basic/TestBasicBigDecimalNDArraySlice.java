...
class TestBasicBigDecimalNDArraySlice extends TestBase {
    ...
    @Test
    void testSliceSlice() {
        NDArray<BigDecimal> slice2 = slice.slice(":", 2);
    ...
    void testStrided() {
        ...
        NDArray<BigDecimal> slice2 = array.slice(new Range(1, 5, 4), ":2:", new Range(0, 3));
    ...
    void testStridedNegativeStepSize() {
        int[] expectedshape = { 1, 3, 3 };
        NDArray<BigDecimal> slice2 = array.slice(new Range(-1, -5, 0), ":-2:", "0::3");
        assertArrayEquals(expectedshape, slice2.shape());
        assertEquals(IntStream.of(expectedshape).reduce(1, (acc, value) -> acc * value), slice2.length());
        assertEquals(expectedshape[0], slice2.shape(0));
        assertEquals(expectedshape.length, slice2.ndim());
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<BigDecimal>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        if (!array.dtype().equals(Complex.class)) {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<BigDecimal>(3 × 3)" + System.lineSeparator())
                    .append(String.format(lineFormat, wrapToBigDecimal(5), wrapToBigDecimal(25), wrapToBigDecimal(45)))
                    .append(String.format(lineFormat, wrapToBigDecimal(9), wrapToBigDecimal(29), wrapToBigDecimal(49)))
                    .append(String.format(lineFormat, wrapToBigDecimal(13), wrapToBigDecimal(33), wrapToBigDecimal(53))).toString();
        } else {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<BigDecimal>(3 × 3)" + System.lineSeparator())
    ...
    void testConcatenate() {
        NDArray<BigDecimal> array2 = new BasicBigDecimalNDArray(3, 5).fill(1);
        NDArray<BigDecimal> array3 = slice.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<BigDecimal> array2 = array.copy().fill(1).slice(":3", "1:3", 1);
        NDArray<BigDecimal> array3 = new BasicBigDecimalNDArray(4, 3).permuteDims(1, 0);
        NDArray<BigDecimal> array4 = new BasicBigDecimalNDArray(15).fill(2).reshape(3, 5);
        NDArray<BigDecimal> array5 = slice.concatenate(1, array2, array3, array4);
        int start = 0;
    ...
    @Test
    void testEquals() {
        NDArray<BigDecimal> slice2 = array.slice(1, new Range(1, 4), Range.ALL);
