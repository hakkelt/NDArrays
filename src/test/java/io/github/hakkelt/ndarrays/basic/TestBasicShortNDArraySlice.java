...
class TestBasicShortNDArraySlice extends TestBase {
    ...
    @Test
    void testSliceSlice() {
        NDArray<Short> slice2 = slice.slice(":", 2);
    ...
    void testStrided() {
        ...
        NDArray<Short> slice2 = array.slice(new Range(1, 5, 4), ":2:", new Range(0, 3));
    ...
    void testStridedNegativeStepSize() {
        int[] expectedshape = { 1, 3, 3 };
        NDArray<Short> slice2 = array.slice(new Range(-1, -5, 0), ":-2:", "0::3");
        assertArrayEquals(expectedshape, slice2.shape());
        assertEquals(IntStream.of(expectedshape).reduce(1, (acc, value) -> acc * value), slice2.length());
        assertEquals(expectedshape[0], slice2.shape(0));
        assertEquals(expectedshape.length, slice2.ndim());
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Short>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        if (!array.dtype().equals(Complex.class)) {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Short>(3 × 3)" + System.lineSeparator())
                    .append(String.format(lineFormat, wrapToShort(5), wrapToShort(25), wrapToShort(45)))
                    .append(String.format(lineFormat, wrapToShort(9), wrapToShort(29), wrapToShort(49)))
                    .append(String.format(lineFormat, wrapToShort(13), wrapToShort(33), wrapToShort(53))).toString();
        } else {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Short>(3 × 3)" + System.lineSeparator())
    ...
    void testConcatenate() {
        NDArray<Short> array2 = new BasicShortNDArray(3, 5).fill(1);
        NDArray<Short> array3 = slice.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<Short> array2 = array.copy().fill(1).slice(":3", "1:3", 1);
        NDArray<Short> array3 = new BasicShortNDArray(4, 3).permuteDims(1, 0);
        NDArray<Short> array4 = new BasicShortNDArray(15).fill(2).reshape(3, 5);
        NDArray<Short> array5 = slice.concatenate(1, array2, array3, array4);
        int start = 0;
    ...
    @Test
    void testEquals() {
        NDArray<Short> slice2 = array.slice(1, new Range(1, 4), Range.ALL);
