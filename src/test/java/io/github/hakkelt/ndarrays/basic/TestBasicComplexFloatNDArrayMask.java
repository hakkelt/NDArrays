...
class TestBasicComplexFloatNDArrayMask extends TestBase {
    ...
    void testNotEqual() {
        ...
        assertNotEquals(masked, new BasicComplexFloatNDArray(4, 15));
        assertNotEquals(masked, new BasicComplexFloatNDArray(4, 3, 5));
    }
    ...
    void testEqualWithDifferentType() {
        NDArray<?> array2 = new BasicComplexDoubleNDArray(masked);
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Complex Float>(30)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder().append(array.getNamePrefix() + " NDArrayView<Complex Float>(30)")
    ...
    void testConcatenate() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Complex> array3 = new BasicComplexFloatNDArray(5).permuteDims(0);
        NDArray<Complex> array4 = new BasicComplexFloatNDArray(3, 3).fill(2).reshape(9);
    ...
    void testDimensionMismatchMask() {
        mask = new BasicComplexFloatNDArray(4, 3, 5).fill(1);
    ...
    void testIdentityMask() {
        mask = new BasicComplexFloatNDArray(array.shape()).fill(1);
