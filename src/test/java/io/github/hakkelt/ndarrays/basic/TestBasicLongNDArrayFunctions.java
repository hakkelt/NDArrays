...
class TestBasicLongNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<Long>(4 × 5 × 3)", str);
    }

    @Test
    void testcontentToString() {
        String str = array.contentToString();
        String firstLine = array.getNamePrefix() + " NDArray<Long>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicLongNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToLong(index));
        NDArray<Long> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicLongNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToLong(index));
        NDArray<Long> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicLongNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToLong(index));
        NDArray<Long> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<Long> array2 = new BasicLongNDArray(4, 2, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Long> array3 = new BasicLongNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<Long> array4 = new BasicLongNDArray(12).fill(2).reshape(4, 1, 3);
