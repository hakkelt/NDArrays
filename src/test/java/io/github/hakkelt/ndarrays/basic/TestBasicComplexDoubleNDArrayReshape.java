...
class TestBasicComplexDoubleNDArrayReshape extends TestBase {
    ...
    void testNotEqual() {
        ...
        assertNotEquals(reshaped, new BasicComplexDoubleNDArray(10, 2, 3));
        assertNotEquals(reshaped, new BasicComplexDoubleNDArray(6, 10));
    }
    ...
    void testEqualWithDifferentType() {
        NDArray<?> array2 = new BasicComplexFloatNDArray(reshaped);
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Complex Double>(20 × 3)", str);
    }
    ...
    void testContentToString() {
        ...
        sb.append(array.getNamePrefix() + " NDArrayView<Complex Double>(20 × 3)" + System.lineSeparator());
        for (int i = 0; i < 20; i++)
    ...
    void testConcatenate() {
        NDArray<Complex> array2 = new BasicComplexDoubleNDArray(13, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Complex> array3 = new BasicComplexDoubleNDArray(3, 5).permuteDims(1, 0);
        NDArray<Complex> array4 = new BasicComplexDoubleNDArray(3, 6).fill(2).reshape(6, 3);
