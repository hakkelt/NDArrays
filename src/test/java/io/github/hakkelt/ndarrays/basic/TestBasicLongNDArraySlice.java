...
class TestBasicLongNDArraySlice extends TestBase {
    ...
    void testStrided() {
        ...
        NDArray<Long> slice2 = array.slice(new Range(1, 5, 4), ":2:", new Range(0, 3));
    ...
    void testStridedNegativeStepSize() {
        int[] expectedshape = { 1, 3, 3 };
        NDArray<Long> slice2 = array.slice(new Range(-1, -5, 0), ":-2:", "0::3");
        assertArrayEquals(expectedshape, slice2.shape());
        assertEquals(IntStream.of(expectedshape).reduce(1, (acc, value) -> acc * value), slice2.length());
        assertEquals(expectedshape[0], slice2.shape(0));
        assertEquals(expectedshape.length, slice2.ndim());
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Long>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        if (!array.dtype().equals(Complex.class)) {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Long>(3 × 3)" + System.lineSeparator())
                    .append(String.format(lineFormat, wrapToLong(5), wrapToLong(25), wrapToLong(45)))
                    .append(String.format(lineFormat, wrapToLong(9), wrapToLong(29), wrapToLong(49)))
                    .append(String.format(lineFormat, wrapToLong(13), wrapToLong(33), wrapToLong(53))).toString();
        } else {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Long>(3 × 3)" + System.lineSeparator())
    ...
    void testConcatenate() {
        NDArray<Long> array2 = new BasicLongNDArray(3, 5).fill(1);
        NDArray<Long> array3 = slice.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<Long> array2 = array.copy().fill(1).slice(":3", "1:3", 1);
        NDArray<Long> array3 = new BasicLongNDArray(4, 3).permuteDims(1, 0);
        NDArray<Long> array4 = new BasicLongNDArray(15).fill(2).reshape(3, 5);
        NDArray<Long> array5 = slice.concatenate(1, array2, array3, array4);
        int start = 0;
    ...
    @Test
    void testEquals() {
        NDArray<Long> slice2 = array.slice(1, new Range(1, 4), Range.ALL);
