...
class TestBasicLongNDArrayMisc extends TestBase {
    ...
    void setup() {
        ...
        array.fillUsingLinearIndices(TestBase::wrapToLong);
    ...
    void testDTypeWithArray() {
        assertEquals(Long.class, array.dtype());
    }
    ...
    void testDTypeWithReshaped() {
        assertEquals(Long.class, reshaped.dtype());
    }

    @Test
    void testDTypeWithPArray() {
        assertEquals(Long.class, pArray.dtype());
    }
    ...
    void testWrongToArrayWithArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> array.toArray(new Long[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithSlice() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> slice.toArray(new Long[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithReshaped() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> reshaped.toArray(new Long[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithPArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> pArray.toArray(new Long[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithMasked() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> masked.toArray(new Long[0][][]));
    ...
    void testNotEqualsWithArray() {
        ...
        assertNotEquals(array, new BasicLongNDArray(IntStream.of(array.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(array, new BasicLongNDArray(array.shape()));
    }
    ...
    void testNotEqualsWithSlice() {
        ...
        assertNotEquals(slice, new BasicLongNDArray(IntStream.of(slice.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(slice, new BasicLongNDArray(slice.shape()));
    }
    ...
    void testNotEqualsWithReshaped() {
        ...
        assertNotEquals(reshaped, new BasicLongNDArray(IntStream.of(reshaped.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(reshaped, new BasicLongNDArray(reshaped.shape()));
    }
    ...
    void testNotEqualsWithPArray() {
        ...
        assertNotEquals(pArray, new BasicLongNDArray(IntStream.of(pArray.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(pArray, new BasicLongNDArray(pArray.shape()));
    }
    ...
    void testNotEqualsWithMasked() {
        ...
        assertNotEquals(masked, new BasicLongNDArray(IntStream.of(masked.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(masked, new BasicLongNDArray(masked.shape()));
    }
    ...
    void testSliceEqualsWithSameType() {
        NDArray<Long> slice2 = array.slice(1, "1:4", "0:");
        assertEquals(slice, slice2);
        NDArray<Long> slice3 = array.copy().slice(1, "1:4", "0:");
    ...
    void testPArrayEqualsWithSameType() {
        ...
        NDArray<Long> pArray3 = array.copy().permuteDims(0, 2, 1);
    ...
    void testMaskedEqualsWithSameType() {
        ...
        NDArray<Long> masked3 = array.copy().mask(mask);
        assertEquals(masked, masked3);
        NDArray<Long> masked4 = array.mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked4);
        NDArray<Long> masked5 = array.copy().mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked5);
        NDArray<Long> masked6 = array.maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked6);
        NDArray<Long> masked7 = array.copy().maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked7);
        NDArray<Long> masked8 = array.maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
        assertEquals(masked, masked8);
        NDArray<Long> masked9 = array.copy().maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
        assertEquals(masked, masked9);
    }

    @Test
    void testArrayEqualsWithDifferentType() {
        NDArray<?> array2 = new BasicShortNDArray(array);
        assertEquals(array, array2);
        array2.set(0, 10);
        assertNotEquals(array, array2);
    }
    ...
    void testSliceEqualsWithDifferentType() {
        NDArray<?> slice2 = new BasicShortNDArray(array).slice(1, "1:4", "0:");
        assertEquals(slice, slice2);
    }

    @Test
    void testReshapedEqualsWithDifferentType() {
        NDArray<?> reshaped2 = new BasicShortNDArray(array).reshape(20, 3);
        assertEquals(reshaped, reshaped2);
    }

    @Test
    void testPArrayEqualsWithDifferentType() {
        NDArray<?> pArray2 = new BasicShortNDArray(array).permuteDims(0, 2, 1);
        assertEquals(pArray, pArray2);
    }

    @Test
    void testMaskedEqualsWithDifferentType() {
        NDArray<? extends Number> array2 = new BasicShortNDArray(array);
    ...
    void testFillDoubleWithArray() {
        array.fill(3);
        for (Long elem : array)
            assertSpecializedEquals(wrapToLong(3), elem);
    }
    ...
    void testContaintsWithArray() {
        assertTrue(array.contains(wrapToLong(5)));
    }

    @Test
    void testContaintsWithSlice() {
        assertTrue(slice.contains(wrapToLong(5)));
    }

    @Test
    void testContaintsWithReshaped() {
        assertTrue(reshaped.contains(wrapToLong(5)));
    }

    @Test
    void testContaintsWithPArray() {
        assertTrue(pArray.contains(wrapToLong(5)));
    }

    @Test
    void testContaintsWithMasked() {
        assertTrue(masked.contains(wrapToLong(5)));
    }
