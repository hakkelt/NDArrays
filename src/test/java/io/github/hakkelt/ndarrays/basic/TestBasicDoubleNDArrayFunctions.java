...
class TestBasicDoubleNDArrayFunctions extends TestBase {
    ...
    void testcontentToString() {
        ...
        String firstLine = array.getNamePrefix() + " NDArray<Double>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicDoubleNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToDouble(index));
        NDArray<Double> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicDoubleNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToDouble(index));
        NDArray<Double> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicDoubleNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToDouble(index));
        NDArray<Double> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
