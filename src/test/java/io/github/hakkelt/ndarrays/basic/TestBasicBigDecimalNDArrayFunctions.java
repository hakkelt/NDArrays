...
class TestBasicBigDecimalNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<BigDecimal>(4 × 5 × 3)", str);
    }

    @Test
    void testcontentToString() {
        String str = array.contentToString();
        String firstLine = array.getNamePrefix() + " NDArray<BigDecimal>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicBigDecimalNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigDecimal(index));
        NDArray<BigDecimal> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicBigDecimalNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigDecimal(index));
        NDArray<BigDecimal> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicBigDecimalNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToBigDecimal(index));
        NDArray<BigDecimal> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<BigDecimal> array2 = new BasicBigDecimalNDArray(4, 2, 3).fill(1);
        NDArray<BigDecimal> array3 = array.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<BigDecimal> array2 = array.copy().fill(1).slice(":", "1:3", ":");
        NDArray<BigDecimal> array3 = new BasicBigDecimalNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<BigDecimal> array4 = new BasicBigDecimalNDArray(12).fill(2).reshape(4, 1, 3);
        NDArray<BigDecimal> array5 = array.concatenate(1, array2, array3, array4);
        int start = 0;
