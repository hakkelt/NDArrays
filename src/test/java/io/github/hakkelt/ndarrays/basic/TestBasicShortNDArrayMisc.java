...
class TestBasicShortNDArrayMisc extends TestBase {
    ...
    void setup() {
        ...
        array.fillUsingLinearIndices(TestBase::wrapToShort);
    ...
    void testDTypeWithArray() {
        assertEquals(Short.class, array.dtype());
    }

    @Test
    void testDTypeWithSlice() {
        assertEquals(Short.class, slice.dtype());
    }

    @Test
    void testDTypeWithReshaped() {
        assertEquals(Short.class, reshaped.dtype());
    }
    ...
    void testDTypeWithMasked() {
        assertEquals(Short.class, masked.dtype());
    }

    @Test
    void testWrongToArrayWithArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> array.toArray(new Short[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithSlice() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> slice.toArray(new Short[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithReshaped() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> reshaped.toArray(new Short[0][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 3, 2), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithPArray() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> pArray.toArray(new Short[0][][][]));
        assertEquals(String.format(Errors.TOARRAY_DEPTH_MISMATCH, 4, 3), exception.getMessage());
    }

    @Test
    void testWrongToArrayWithMasked() {
        Exception exception = assertThrows(ArrayStoreException.class, () -> masked.toArray(new Short[0][][]));
    ...
    void testNotEqualsWithArray() {
        ...
        assertNotEquals(array, new BasicShortNDArray(IntStream.of(array.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(array, new BasicShortNDArray(array.shape()));
    }
    ...
    void testNotEqualsWithSlice() {
        ...
        assertNotEquals(slice, new BasicShortNDArray(IntStream.of(slice.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(slice, new BasicShortNDArray(slice.shape()));
    }
    ...
    void testNotEqualsWithReshaped() {
        ...
        assertNotEquals(reshaped, new BasicShortNDArray(IntStream.of(reshaped.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(reshaped, new BasicShortNDArray(reshaped.shape()));
    }
    ...
    void testNotEqualsWithPArray() {
        ...
        assertNotEquals(pArray, new BasicShortNDArray(IntStream.of(pArray.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(pArray, new BasicShortNDArray(pArray.shape()));
    }
    ...
    void testNotEqualsWithMasked() {
        ...
        assertNotEquals(masked, new BasicShortNDArray(IntStream.of(masked.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(masked, new BasicShortNDArray(masked.shape()));
    }
    ...
    void testSliceEqualsWithSameType() {
        NDArray<Short> slice2 = array.slice(1, "1:4", "0:");
        assertEquals(slice, slice2);
        NDArray<Short> slice3 = array.copy().slice(1, "1:4", "0:");
    ...
    void testPArrayEqualsWithSameType() {
        ...
        NDArray<Short> pArray3 = array.copy().permuteDims(0, 2, 1);
    ...
    void testMaskedEqualsWithSameType() {
        ...
        NDArray<Short> masked3 = array.copy().mask(mask);
        assertEquals(masked, masked3);
        NDArray<Short> masked4 = array.mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked4);
        NDArray<Short> masked5 = array.copy().mask(value -> value.intValue() % 2 == 1);
        assertEquals(masked, masked5);
        NDArray<Short> masked6 = array.maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked6);
        NDArray<Short> masked7 = array.copy().maskWithLinearIndices((value, i) -> i.intValue() % 2 == 1);
        assertEquals(masked, masked7);
        NDArray<Short> masked8 = array.maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
        assertEquals(masked, masked8);
        NDArray<Short> masked9 = array.copy().maskWithCartesianIndices((value, idx) -> value.intValue() % 2 == 1);
    ...
    void testCopyWithMasked() {
        NDArray<Short> array2 = masked.copy();
    ...
    void testFillDoubleWithArray() {
        ...
        for (Short elem : array)
            assertSpecializedEquals(wrapToShort(3), elem);
    }
    ...
    void testFillDoubleWithMasked() {
        masked.fill(3);
        for (Short elem : masked)
            assertSpecializedEquals(wrapToShort(3), elem);
    }

    @Test
    void testFillTWithArray() {
        array.fill(wrapToShort(3));
        for (Short elem : array)
            assertSpecializedEquals(wrapToShort(3), elem);
    }
    ...
    void testContaintsWithArray() {
        assertTrue(array.contains(wrapToShort(5)));
    }

    @Test
    void testContaintsWithSlice() {
        assertTrue(slice.contains(wrapToShort(5)));
    }

    @Test
    void testContaintsWithReshaped() {
        assertTrue(reshaped.contains(wrapToShort(5)));
    }

    @Test
    void testContaintsWithPArray() {
        assertTrue(pArray.contains(wrapToShort(5)));
    }

    @Test
    void testContaintsWithMasked() {
        assertTrue(masked.contains(wrapToShort(5)));
    }
