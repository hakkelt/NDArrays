...
class TestBasicBigDecimalNDArrayConstructors extends TestBase {

    @Test
    void testDimsConstructor() {
        int[] shape = { 2, 4 };
        NDArray<BigDecimal> array = new BasicBigDecimalNDArray(shape);
    ...
    void testWrongType3DArrayConstructor() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> BasicBigDecimalNDArray.of(array));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        String[] array2 = {"asdf", "", null};
        exception = assertThrows(IllegalArgumentException.class, () -> BasicBigDecimalNDArray.of(array2));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        char[][][] array3 = new char[4][5][3];
        exception = assertThrows(IllegalArgumentException.class, () -> BasicBigDecimalNDArray.of(array3));
    ...
    void test1DArrayConstructorsWithByte() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = wrapToByte(i);
        NDArray<BigDecimal> array = BasicBigDecimalNDArray.of(real);
        for (int i = 0; i < real.length; i++)
            assertSpecializedEquals(BigDecimal.valueOf((double) i), array.get(i));
    }
    ...
    void test2DFloatArrayConstructorsWithBigInteger() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                assertSpecializedEquals(BigDecimal.valueOf((double) (i * real.length + j)), array.get(i, j));
    }
    ...
    void test3DFloatArrayConstructorsWithBigDecimal() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                for (int k = 0; k < real[i][j].length; k++)
                    assertSpecializedEquals(BigDecimal.valueOf((double) ((i * real.length + j) * real[i].length + k)),
                            array.get(i, j, k));
    }
    ...
    void testCopyConstructorWithByte() {
        ...
        NDArray<BigDecimal> array2 = new BasicBigDecimalNDArray(array1);
        array1.set(0, 2, 2, 2);
    ...
    void testWrongCopyFrom1DArrayWithFloat() {
        NDArray<BigDecimal> array = new BasicBigDecimalNDArray(4, 3, 5);
        ...
        NDArray<BigDecimal> array2 = new BasicBigDecimalNDArray(5);
        ...
        NDArray<BigDecimal> array3 = new BasicBigDecimalNDArray(3, 5);
