...
class TestBasicComplexDoubleNDArraySlice extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Complex Double>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        if (!array.dtype().equals(Complex.class)) {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Complex Double>(3 × 3)" + System.lineSeparator())
    ...
    void testConcatenate() {
        NDArray<Complex> array2 = new BasicComplexDoubleNDArray(3, 5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Complex> array3 = new BasicComplexDoubleNDArray(4, 3).permuteDims(1, 0);
        NDArray<Complex> array4 = new BasicComplexDoubleNDArray(15).fill(2).reshape(3, 5);
