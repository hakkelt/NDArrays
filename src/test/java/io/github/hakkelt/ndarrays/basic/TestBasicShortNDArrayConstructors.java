...
class TestBasicShortNDArrayConstructors extends TestBase {

    @Test
    void testDimsConstructor() {
        int[] shape = { 2, 4 };
        NDArray<Short> array = new BasicShortNDArray(shape);
    ...
    void testWrongType3DArrayConstructor() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> BasicShortNDArray.of(array));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        String[] array2 = {"asdf", "", null};
        exception = assertThrows(IllegalArgumentException.class, () -> BasicShortNDArray.of(array2));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        char[][][] array3 = new char[4][5][3];
        exception = assertThrows(IllegalArgumentException.class, () -> BasicShortNDArray.of(array3));
    ...
    void test1DArrayConstructorsWithByte() {
        ...
        for (int i = 0; i < real.length; i++)
            assertSpecializedEquals(Short.valueOf((short) i), array.get(i));
    }
    ...
    void test2DFloatArrayConstructorsWithBigInteger() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                assertSpecializedEquals(Short.valueOf((short) (i * real.length + j)), array.get(i, j));
    }
    ...
    void test3DFloatArrayConstructorsWithBigDecimal() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                for (int k = 0; k < real[i][j].length; k++)
                    assertSpecializedEquals(Short.valueOf((short) ((i * real.length + j) * real[i].length + k)),
                            array.get(i, j, k));
    }
    ...
    void testWrongCopyFrom1DArrayWithFloat() {
        NDArray<Short> array = new BasicShortNDArray(4, 3, 5);
        ...
        NDArray<Short> array2 = new BasicShortNDArray(5);
        ...
        NDArray<Short> array3 = new BasicShortNDArray(3, 5);
