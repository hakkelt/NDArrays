...
class TestBasicIntegerNDArraySlice extends TestBase {
    ...
    void testStrided() {
        ...
        NDArray<Integer> slice2 = array.slice(new Range(1, 5, 4), ":2:", new Range(0, 3));
    ...
    void testStridedNegativeStepSize() {
        int[] expectedshape = { 1, 3, 3 };
        NDArray<Integer> slice2 = array.slice(new Range(-1, -5, 0), ":-2:", "0::3");
        assertArrayEquals(expectedshape, slice2.shape());
        assertEquals(IntStream.of(expectedshape).reduce(1, (acc, value) -> acc * value), slice2.length());
        assertEquals(expectedshape[0], slice2.shape(0));
        assertEquals(expectedshape.length, slice2.ndim());
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Integer>(3 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        if (!array.dtype().equals(Complex.class)) {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Integer>(3 × 3)" + System.lineSeparator())
                    .append(String.format(lineFormat, wrapToInteger(5), wrapToInteger(25), wrapToInteger(45)))
                    .append(String.format(lineFormat, wrapToInteger(9), wrapToInteger(29), wrapToInteger(49)))
                    .append(String.format(lineFormat, wrapToInteger(13), wrapToInteger(33), wrapToInteger(53))).toString();
        } else {
            expected = new StringBuilder()
                    .append(array.getNamePrefix() + " NDArrayView<Integer>(3 × 3)" + System.lineSeparator())
    ...
    void testConcatenate() {
        NDArray<Integer> array2 = new BasicIntegerNDArray(3, 5).fill(1);
        NDArray<Integer> array3 = slice.concatenate(1, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<Integer> array2 = array.copy().fill(1).slice(":3", "1:3", 1);
        NDArray<Integer> array3 = new BasicIntegerNDArray(4, 3).permuteDims(1, 0);
        NDArray<Integer> array4 = new BasicIntegerNDArray(15).fill(2).reshape(3, 5);
        NDArray<Integer> array5 = slice.concatenate(1, array2, array3, array4);
        int start = 0;
    ...
    @Test
    void testEquals() {
        NDArray<Integer> slice2 = array.slice(1, new Range(1, 4), Range.ALL);
