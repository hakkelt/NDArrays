...
class TestBasicComplexDoubleNDArrayMisc extends TestBase {
    ...
    void setup() {
        ...
        array.fillUsingLinearIndices(TestBase::wrapToComplex);
    ...
    void testNotEqualsWithArray() {
        ...
        assertNotEquals(array, new BasicComplexDoubleNDArray(IntStream.of(array.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(array, new BasicComplexDoubleNDArray(array.shape()));
    }
    ...
    void testNotEqualsWithSlice() {
        ...
        assertNotEquals(slice, new BasicComplexDoubleNDArray(IntStream.of(slice.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(slice, new BasicComplexDoubleNDArray(slice.shape()));
    }
    ...
    void testNotEqualsWithReshaped() {
        ...
        assertNotEquals(reshaped, new BasicComplexDoubleNDArray(IntStream.of(reshaped.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(reshaped, new BasicComplexDoubleNDArray(reshaped.shape()));
    }
    ...
    void testNotEqualsWithPArray() {
        ...
        assertNotEquals(pArray, new BasicComplexDoubleNDArray(IntStream.of(pArray.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(pArray, new BasicComplexDoubleNDArray(pArray.shape()));
    }
    ...
    void testNotEqualsWithMasked() {
        ...
        assertNotEquals(masked, new BasicComplexDoubleNDArray(IntStream.of(masked.shape()).reduce(1, (acc, value) -> acc * value)));
        assertNotEquals(masked, new BasicComplexDoubleNDArray(masked.shape()));
    }
    ...
    void testArrayEqualsWithDifferentType() {
        NDArray<?> array2 = new BasicComplexFloatNDArray(array);
        assertEquals(array, array2);
        array2.set(0, 10);
        assertNotEquals(array, array2);
    }
    ...
    void testSliceEqualsWithDifferentType() {
        NDArray<?> slice2 = new BasicComplexFloatNDArray(array).slice(1, "1:4", "0:");
        assertEquals(slice, slice2);
    }

    @Test
    void testReshapedEqualsWithDifferentType() {
        NDArray<?> reshaped2 = new BasicComplexFloatNDArray(array).reshape(20, 3);
        assertEquals(reshaped, reshaped2);
    }

    @Test
    void testPArrayEqualsWithDifferentType() {
        NDArray<?> pArray2 = new BasicComplexFloatNDArray(array).permuteDims(0, 2, 1);
        assertEquals(pArray, pArray2);
    }

    @Test
    void testMaskedEqualsWithDifferentType() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(array);
