...
class TestBasicFloatNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<Float>(4 × 5 × 3)", str);
    }

    @Test
    void testcontentToString() {
        String str = array.contentToString();
        String firstLine = array.getNamePrefix() + " NDArray<Float>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicFloatNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToFloat(index));
        NDArray<Float> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicFloatNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToFloat(index));
        NDArray<Float> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicFloatNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToFloat(index));
        NDArray<Float> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<Float> array2 = new BasicFloatNDArray(4, 2, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Float> array3 = new BasicFloatNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<Float> array4 = new BasicFloatNDArray(12).fill(2).reshape(4, 1, 3);
