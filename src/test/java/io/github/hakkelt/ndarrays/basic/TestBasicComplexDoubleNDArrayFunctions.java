...
class TestBasicComplexDoubleNDArrayFunctions extends TestBase {
    ...
    void testcontentToString() {
        ...
        String firstLine = array.getNamePrefix() + " NDArray<Complex Double>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicComplexDoubleNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToComplex(index));
    ...
    void testConcatenate() {
        NDArray<Complex> array2 = new BasicComplexDoubleNDArray(4, 2, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Complex> array3 = new BasicComplexDoubleNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<Complex> array4 = new BasicComplexDoubleNDArray(12).fill(2).reshape(4, 1, 3);
