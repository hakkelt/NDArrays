...
class TestBasicShortNDArrayFunctions extends TestBase {
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArray<Short>(4 × 5 × 3)", str);
    }

    @Test
    void testcontentToString() {
        String str = array.contentToString();
        String firstLine = array.getNamePrefix() + " NDArray<Short>(4 × 5 × 3)" + System.lineSeparator();
    ...
    @Test
    void testSelectDims() {
        array = new BasicShortNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToShort(index));
        NDArray<Short> slice = array.selectDims(0, 2, 3, 4);
    ...
    void testSqueeze() {
        array = new BasicShortNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToShort(index));
        NDArray<Short> slice = array.squeeze();
    ...
    void testDropDims() {
        array = new BasicShortNDArray(4, 1, 5, 1, 3);
        array.applyWithLinearIndices((value, index) -> wrapToShort(index));
        NDArray<Short> slice = array.dropDims(1, 3);
        assertArrayEquals(new int[]{4, 5, 3}, slice.shape());
    }
    ...
    void testConcatenate() {
        NDArray<Short> array2 = new BasicShortNDArray(4, 2, 3).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Short> array3 = new BasicShortNDArray(3, 4, 4).permuteDims(2, 1, 0);
        NDArray<Short> array4 = new BasicShortNDArray(12).fill(2).reshape(4, 1, 3);
