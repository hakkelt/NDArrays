...
class TestBasicBigIntegerNDArrayReshape extends TestBase {
    ...
    void testNotEqual() {
        ...
        assertNotEquals(reshaped, new BasicBigIntegerNDArray(10, 2, 3));
        assertNotEquals(reshaped, new BasicBigIntegerNDArray(6, 10));
    }
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<BigInteger>(20 × 3)", str);
    }
    ...
    void testContentToString() {
        ...
        sb.append(array.getNamePrefix() + " NDArrayView<BigInteger>(20 × 3)" + System.lineSeparator());
        for (int i = 0; i < 20; i++)
            if (reshaped.dtype() == Complex.class)
                ...
                sb.append(String.format(lineFormat, wrapToBigInteger(i), wrapToBigInteger(i + 20), wrapToBigInteger(i + 40)));
    ...
    void testConcatenate() {
        NDArray<BigInteger> array2 = new BasicBigIntegerNDArray(13, 3).fill(1);
        NDArray<BigInteger> array3 = reshaped.concatenate(0, array2);
    ...
    void testConcatenateMultiple() {
        NDArray<BigInteger> array2 = reshaped.copy().fill(1).slice(":10", ":");
        NDArray<BigInteger> array3 = new BasicBigIntegerNDArray(3, 5).permuteDims(1, 0);
        NDArray<BigInteger> array4 = new BasicBigIntegerNDArray(3, 6).fill(2).reshape(6, 3);
        NDArray<BigInteger> array5 = reshaped.concatenate(0, array2, array3, array4);
        int start = 0;
    ...
    void testReshapeReshaped() {
        NDArray<BigInteger> reshaped2 = reshaped.reshape(4, 15);
