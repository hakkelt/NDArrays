...
class TestBasicBigIntegerNDArrayConstructors extends TestBase {

    @Test
    void testDimsConstructor() {
        int[] shape = { 2, 4 };
        NDArray<BigInteger> array = new BasicBigIntegerNDArray(shape);
    ...
    void testWrongType3DArrayConstructor() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> BasicBigIntegerNDArray.of(array));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        String[] array2 = {"asdf", "", null};
        exception = assertThrows(IllegalArgumentException.class, () -> BasicBigIntegerNDArray.of(array2));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        char[][][] array3 = new char[4][5][3];
        exception = assertThrows(IllegalArgumentException.class, () -> BasicBigIntegerNDArray.of(array3));
    ...
    void test1DArrayConstructorsWithByte() {
        ...
        for (int i = 0; i < real.length; i++)
            real[i] = wrapToByte(i);
        NDArray<BigInteger> array = BasicBigIntegerNDArray.of(real);
        for (int i = 0; i < real.length; i++)
            assertSpecializedEquals(BigInteger.valueOf((long) i), array.get(i));
    }
    ...
    void test2DFloatArrayConstructorsWithBigInteger() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                assertSpecializedEquals(BigInteger.valueOf((long) (i * real.length + j)), array.get(i, j));
    }
    ...
    void test3DFloatArrayConstructorsWithBigDecimal() {
        ...
        for (int i = 0; i < real.length; i++)
            for (int j = 0; j < real[i].length; j++)
                for (int k = 0; k < real[i][j].length; k++)
                    assertSpecializedEquals(BigInteger.valueOf((long) ((i * real.length + j) * real[i].length + k)),
                            array.get(i, j, k));
    }
    ...
    void testCopyConstructorWithByte() {
        ...
        NDArray<BigInteger> array2 = new BasicBigIntegerNDArray(array1);
        array1.set(0, 2, 2, 2);
    ...
    void testWrongCopyFrom1DArrayWithFloat() {
        NDArray<BigInteger> array = new BasicBigIntegerNDArray(4, 3, 5);
        ...
        NDArray<BigInteger> array2 = new BasicBigIntegerNDArray(5);
        ...
        NDArray<BigInteger> array3 = new BasicBigIntegerNDArray(3, 5);
