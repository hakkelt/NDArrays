...
class TestBasicComplexFloatNDArrayIteration extends TestBase {
    ...
    void setup() {
        ...
        mask = new BasicComplexFloatNDArray(array.mapWithLinearIndices((value, index) -> wrapToComplex(index % 2)));
    ...
    void testApplyWithSlice() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(slice);
    ...
    void testApplyWithReshaped() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(reshaped);
    ...
    void testApplyWithPArray() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(pArray);
    ...
    void testApplyWithMasked() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(masked);
