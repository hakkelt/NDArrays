...
class TestBasicComplexFloatNDArrayPermuteDims extends TestBase {
    ...
    void testNotEqual() {
        ...
        assertNotEquals(pArray, new BasicComplexFloatNDArray(6, 10));
        assertNotEquals(pArray, new BasicComplexFloatNDArray(4, 5, 3));
    }
    ...
    void testEqualWithDifferentType() {
        NDArray<?> array2 = new BasicComplexDoubleNDArray(pArray);
    ...
    void testToString() {
        ...
        assertEquals(array.getNamePrefix() + " NDArrayView<Complex Float>(4 × 3 × 5)", str);
    }
    ...
    void testConcatenate() {
        NDArray<Complex> array2 = new BasicComplexFloatNDArray(2, 3, 5).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Complex> array3 = new BasicComplexFloatNDArray(2, 5, 4).permuteDims(2, 0, 1);
        NDArray<Complex> array4 = new BasicComplexFloatNDArray(20).fill(2).reshape(4, 1, 5);
