 ...
 * src\test\java\io\github\hakkelt\ndarrays\template\TestComplexNDArrayConstructors.java
 * ---------------------------------------------------------------------------------------------------------------------
 */
...
class TestBasicComplexDoubleNDArrayConstructors extends TestBase {
    ...
    void testWrongType3DArrayConstructor() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> BasicComplexDoubleNDArray.of(array));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        String[] array2 = {"asdf", "", null};
        exception = assertThrows(IllegalArgumentException.class, () -> BasicComplexDoubleNDArray.of(array2));
        assertEquals(String.format(Errors.UNSUPPORTED_TYPE, "String"), exception.getMessage());

        char[][][] array3 = new char[4][5][3];
        exception = assertThrows(IllegalArgumentException.class, () -> BasicComplexDoubleNDArray.of(array3));
    ...
    void testWrongCopyFrom1DArrayWithFloat() {
        ComplexNDArray<Double> array = new BasicComplexDoubleNDArray(4, 3, 5);
        ...
        ComplexNDArray<Double> array2 = new BasicComplexDoubleNDArray(4);
    ...
    void testWrongCopyFrom1DArraysDifferInShapeWithFloat() {
        ...
        ComplexNDArray<Double> array2 = new BasicComplexDoubleNDArray(4, 3, 5);
        ...
        ComplexNDArray<Double> array3 = new BasicComplexDoubleNDArray(4);
        ...
        ComplexNDArray<Double> array4 = new BasicComplexDoubleNDArray(4);
