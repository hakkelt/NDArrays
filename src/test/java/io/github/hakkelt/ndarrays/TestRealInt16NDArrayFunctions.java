...
class TestRealInt16NDArrayFunctions {
    RealInt16NDArray array;
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Short>(4 × 5 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Short>(4 × 5 × 3)" + System.lineSeparator())
    ...
    void testDivideMultiple() {
        NDArray<Short> array2 = new RealInt16NDArray(array.addInplace(1));
    ...
    void test1Norm() {
        ...
        assertTrue(Math.abs((short)norm - array.norm(1)) / (short)norm < 1e-6);
    }
    ...
    void testConcatenate() {
        NDArray<Short> array2 = new RealInt16NDArray(new int[]{4, 2, 3}).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Short> array3 = new RealInt16NDArray(new int[]{3, 4, 4}).permuteDims(2, 1, 0);
        NDArray<Short> array4 = new RealInt16NDArray(new int[]{12}).fill(2).reshape(4, 1, 3);
