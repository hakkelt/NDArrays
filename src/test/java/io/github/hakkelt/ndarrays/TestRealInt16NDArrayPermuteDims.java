...
class TestRealInt16NDArrayPermuteDims {
    ...
    @Test
    void testEltype() {
        assertEquals(Short.class, pArray.eltype());
    }
    ...
    @Test
    void testEqual() {
        NDArray<Short> array2 = new RealInt16NDArray(pArray);
    ...
    void testCollector() {
        NDArray<Short> increased = pArray.stream()
            .map((value) -> value + 1)
            .collect(RealInt16NDArray.getCollector(pArray.dims()));
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Short>(4 × 3 × 5)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Short>(4 × 3 × 5)" + System.lineSeparator())
    ...
    @Test
    void testApply() {
        NDArray<Short> pArray2 = new RealInt16NDArray(array).permuteDims(0, 2, 1);
    ...
    void testMaskPermuted() {
        NDArray<Byte> mask = new RealInt8NDArray(pArray.map(value -> value > 20 ? (short)1 : (short)0));
    ...
    void testConcatenate() {
        NDArray<Short> array2 = new RealInt16NDArray(new int[]{4, 3, 2}).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        NDArray<Short> array3 = new RealInt16NDArray(new int[]{5, 3, 4}).permuteDims(2, 1, 0);
        NDArray<Short> array4 = new RealInt16NDArray(new int[]{36}).fill(2.f).reshape(4, 3, 3);
