...
class TestComplexF64NDArrayFunctions {
    ...
    void testToString() {
        ...
        assertEquals("simple NDArray<Complex Double>(4 × 5 × 3)", str);
    }
    ...
    void testcontentToString() {
        ...
        String expected = new StringBuilder()
            .append("simple NDArray<Complex Double>(4 × 5 × 3)" + System.lineSeparator())
    ...
    @Test
    void testApply() {
        ComplexNDArray<Double> array2 = new ComplexF64NDArray(array).apply(value -> value.atan());
    ...
    void testApplyWithLinearIndices() {
        ComplexNDArray<Double> array2 = new ComplexF64NDArray(array).applyWithLinearIndices((value, index) -> value.atan().add(index));
        for (int i = 1; i < array.length(); i++) {
    ...
    void testApplyWithCartesianIndex() {
        ComplexNDArray<Double> array2 = new ComplexF64NDArray(array).applyWithCartesianIndices((value, indices) -> value.atan().add(indices[0]));
    ...
    void testConcatenate() {
        ComplexNDArray<Double> array2 = new ComplexF64NDArray(new int[]{4, 2, 3}).fill(1);
    ...
    void testConcatenateMultiple() {
        ...
        ComplexNDArray<Double> array3 = new ComplexF64NDArray(new int[]{3, 4, 4}).permuteDims(2, 1, 0);
        ComplexNDArray<Double> array4 = new ComplexF64NDArray(new int[]{12}).fill(new Complex(2, -2)).reshape(4, 1, 3);
