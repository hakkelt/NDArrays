...
public interface NDArray<T> extends Collection<T> {
    ...
    /** 
     * Converts this NDArray to a RS2D DataSet object.
     * 
     * <p>Limitation: this conversion is not possible for arrays that have more than 5 dimensions.
     * 
     * @return a RS2D DataSet object
     */
    public DataSet toRS2DDataSet();
    
    /** 
     * Converts this NDArray to a Simple ITK Image object.
     * 
     * <p>Limitation: this conversion is not possible complex arrays.
     * 
     * @return Image
     */
