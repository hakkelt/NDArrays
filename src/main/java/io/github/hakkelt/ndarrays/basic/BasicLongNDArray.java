...
public class BasicLongNDArray extends AbstractLongNDArray {
     ...
     * NDArray<Long> array2 = BasicLongNDArray.readFromFile(new File("array.nda"));
     ...
     * @return a new BasicLongNDArray whose shape and content is loaded from the given file
