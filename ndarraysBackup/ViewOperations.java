...
public class ViewOperations<T,T2 extends Number> {
    ...
    public static boolean isThisSlicingAnIdentityOperation(NDArray<?> me, Object... slicingExpressions) {
        AtomicInteger index = new AtomicInteger(-1);
        return Stream.of(slicingExpressions).allMatch(obj -> {
            index.incrementAndGet();
            return obj instanceof String &&
                (((String)obj).equals(":") || ((String)obj).equals("0:" + me.shape(index.get())));
        });
    }
    ...
    public static int[] getIndicesOfSingletondim(int... shape) {
    ...
    public NDArray<T2> slice(RealNDArray<T2> me, Object ...slicingExpressions) {
        if (isThisSlicingAnIdentityOperation(me, slicingExpressions)) return me;
    ...
    public NDArray<T> selectDims(AbstractNDArray<T,T2> me, int... selectedDims) {
        ...
        if (set.shape() == me.ndim()) return me;
    ...
    public NDArray<T> squeeze(AbstractNDArray<T,T2> me) {
        return me.selectDims(getIndicesOfSingletondim(me.shape()));
    }
