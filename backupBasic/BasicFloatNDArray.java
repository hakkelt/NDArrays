...
/**
 * Reference implementation for the NDArray of float (single-precision, 32 bit
...
public final class BasicFloatNDArray extends AbstractFloatNDArray {
     ...
     * values.
     * 
     * @param array a list or 1D array of byte values from which a BasicFloatNDArray
     *              is created.
     ...
     * 
     * @param array a list or 1D array of int values from which a BasicFloatNDArray
     *              is created.
     ...
     * values.
     * 
     * @param array a list or 1D array of long values from which a BasicFloatNDArray
     *              is created.
